...
import static com.example.spock.util.SystemConstants.EMAIL_REGEXP;
...
public class NewUserDTO {
  ...
  @JsonCreator
  public NewUserDTO(@JsonProperty("email_address") String emailAddress,
      @JsonProperty("name") String name, @JsonProperty("last_name") String lastName) {
